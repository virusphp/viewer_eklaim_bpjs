...
class LaporanExport implements FromQuery, ShouldAutoSize, WithMapping, WithEvents, WithHeadings
{
    use Exportable;
    ...
    {
        return $this->eklaim->laporanExport($this->request);
    }
