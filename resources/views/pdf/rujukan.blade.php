    ...
    <table class="table table-borderless table-header">
        <tr>
            ...
            <td id="sep-title" colspan="2">
                <p id="sep-title">SURAT RUJUKAN PESERTA </p> 
            </td> 
        </tr> 
        <tr>
            <td id="sep-title">
                <p id="sep-title">{{ $rujukan->rujukan->provPerujuk->nama }}</p> 
            </td>
        </tr> 
    </table>   
    <table class="table table-content">
        <tr>
            ...
            <td colspan="4" id="v-noSep">
                RSUD KRATON Pekalongan - poli {{ $rujukan->rujukan->poliRujukan->nama }}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>No. Kartu</td>
            <td>:</td>
            <td width="38%">{{ $rujukan->rujukan->peserta->noKartu }}</td>
            <td>No Rujukan</td>
            <td>:</td>
            <td width="28%">{{ $rujukan->rujukan->noKunjungan }}</td>
        <tr>
            <td>Nama Peserta</td>
            <td>:</td>
            <td>{{ $rujukan->rujukan->peserta->nama }}</td>
            <td>Tgl. Rujukan</td>
            <td>:</td>
            <td>{{ tanggal($rujukan->rujukan->tglKunjungan) }}</td>
        </tr>
        <tr>
            <td>Tgl. Lahir</td>
            <td>:</td>
            <td>{{ tanggal($rujukan->rujukan->peserta->tglLahir) }}</td>
            <td>Jenis Kelamin</td>
            <td>:</td>
            <td>{{ ($rujukan->rujukan->peserta->sex == "L" ? "Laki-laki" : "Perempuan") }}</td>
        </tr>
        <tr>
            <td>Diagnosa</td>
            <td>:</td>
            <td colspan="4">{{ $rujukan->rujukan->diagnosa->nama }}</td>
        </tr>
        <tr>
            <td>Keterangan</td>
            <td>:</td>
