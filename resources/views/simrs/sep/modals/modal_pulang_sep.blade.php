  ...
  <div class="modal-dialog modal-sm modal-info" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <div class="col-md-6">
            <h5 class="modal-title" id="edit-modal-register">Update Pulang</h5>
        </div>
        <div class="col-md-4">
      ...
      <div class="modal-body">
        ...
        <div id="frame-pulang-error" class="alert alert-danger">
                        ...
                        <div class="form-group clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" id="noSep-pulang" name="noSep" tabindex="1" type="text" placeholder="No Sep" readonly>
                                    <input class="form-control form-control-sm" id="noReg-pulang" name="noReg" tabindex="1" type="hidden" readonly>
